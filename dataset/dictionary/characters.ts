...
export default defineWords([
  ...
  },
  {
    ...
    _meta: {
      translator: {
        enToJa: true,
        jaToEn: false, // 聖遺物の「旧貴族」と判別が困難なため
      },
    },
  },
  {
  ...
  },
  {
    ...
    zhCN: "芭比洛斯",
    tags: [ "mondstadt", "character-sub" ],
    notes: "魔女会・コードB。バーベロスがモナの師匠 (おばば) という説もあるが明言されておらず、おばばはバーベロスの後継者という説もある。",
    notesZh: "魔女会代号B。虽然已经明说芭比洛斯是莫娜的师傅（老太婆），但是也有老太婆是芭比洛斯的继承人的说法。",
  },
  {
    en: "the old hag",
    ja: "おばば",
  ...
  },
  {
    ...
    zhCN: "玛格丽特",
    tags: [ "mondstadt", "character-sub" ],
    notes: "キャッツテールの店主", // en: Boss at Cat's Tail
    notesZh: "猫尾酒馆的店主",
  },
  {
    en: "Draff Kätzlein",
    ...
    zhCN: "杜拉夫·凯茨莱茵",
    tags: [ "mondstadt", "character-sub" ],
    notes: "ディオナの父親で清泉町の狩人のリーダー", // en: Diona's father and the head of the hunters in Springvale
  ...
  },
  {
    ...
    tags: [ "liyue", "title" ],
    notes: "鍾離の往生堂における地位。guest と訳されている箇所もある。", // Source: v2.4「流るる星霜、華咲きて」特設ページ https://webstatic-sea.hoyoverse.com/ys/event/e20211227-pre/
  ...
  },
  {
    ...
    // Source of Vigilant Yaksha: v2.4「流るる星霜、華咲きて」特設ページ https://webstatic-sea.hoyoverse.com/ys/event/e20211227-pre/
  ...
  },
  {
    ...
    zhCN: "草神",
    tags: [ "sumeru", "title" ],
    pronunciationJa: "そうしん", // Source: https://mobile.twitter.com/genshin_kanji/status/1553941527684337664
    variants: {
      ja: [ "そうじん", "くさかみ", "くさがみ" ],
    },
  },
  ...
  },
  {
    ...
    zhCN: "贾尔贾",
    tags: [ "sumeru", "character-sub" ],
    notes: "世界任務「浮光鳴召」で試練を課してくる花霊", // 試練: trial
  },
  {
    en: "Fedhri",
    ja: "フェドフ",
  ...
  //
  {
    ...
    notes: "英語の発音は「シャーロット」。タグのプレイアブル・NPC 分類は仮。",
  },
  {
    en: "Lyney",
    ja: "リネ",
  ...
  },
  {
    ...
    zhCN: "欧芙",
    tags: [ "fontaine", "character-sub" ],
    notes: "フォンテーヌ評判任務の受付キャラクター。スチームバード新聞の編集長", // スチームバード新聞の編集長: the Chief Editor of The Steambird
  },
  {
    en: "Estelle",
    ja: "エスタブレ",
  ...
  },
  {
    ...
    zhCN: "艾尤恩",
    tags: [ "fontaine", "character-sub" ],
    notes: "世界任務「一通の知らせ」「些細な出来事」「とある印章」などに登場する人物",
  ...
  },
  {
    ...
    zhCN: "洛耶茨",
    tags: [ "fontaine", "character-sub" ],
    notes: "アイオーヌの共律庭での先輩。世界任務「一通の知らせ」「些細な出来事」「とある印章」などに登場する人物",
    // related: [ "a-certain-notice", "a-certain-trifle", "a-certain-stamp" ]
  },
  {
    en: "Semaine",
    ...
    zhCN: "瑟米安",
    tags: [ "fontaine", "character-sub" ],
    notes: "世界任務「些細な出来事」「とある印章」などに登場する共律官",
